...
public class CostSensitive {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    Integer numAttr = training.numAttributes();
	   ...
	   // if (msg != null)
	    ...
	    Integer numtesting = testing.numInstances();
	    ...
	    for (Integer i = 0; i < numtesting; i++)
	    {
	        ...
	        String predictedClassLabel =
	            testing.classAttribute().value((int) Math.round(predictionIndex));
	        ...
	        // Loop over all the prediction labels in the distribution.
		        for (Integer predictionDistributionIndex = 0; 
